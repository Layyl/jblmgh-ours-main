            ...
            <div class="card">
                <TabView>
                    ...
                    <TabPanel header="Outbound Patients">
                        ...
                        <DataTable v-else v-model:expandedRows="expandedRows" :value="outboundPatients.referrals" dataKey="referralID" @rowExpand="onRowExpand" @rowCollapse="onRowCollapse" tableStyle="min-width: 60rem">
                                ...
                                <div class="pt-5">
                                    ...
                                    <!-- <DataTable :value="slotProps.data.referralHistory">
                                        ...
                                        <Column header="Referral Status">
                                            <template #body="slotProps">
                                                <Tag :value="getStatus(slotProps.data.referralStatus)" :class="getStatusClass(slotProps.data.referralStatus)" />
                                            </template>
                                        </Column>
                                        <Column headerStyle="width:4rem">
                                            <template #body="slotProps">
                                                <Button @click="redirectToViewPatient(slotProps.data.encryptedReferralID, slotProps.data.encryptedReferralHistoryID)" v-if="slotProps.data.referralStatus === 1" icon="pi pi-eye" />
                                            </template>
                                        </Column>
                                    </DataTable> -->
                                </div>
