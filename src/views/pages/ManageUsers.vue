...
const searchPatient = async () => {
    loading.value = true;
    await axios({
        url: `http://192.163.8.195:90/api/fetchUsers?lastName=${lastName.value}&firstName=${firstName.value}&middleName=${middleName.value}&hospital=${hciID.value}`,
        method: 'GET',
        headers: header,
        data: {}
    }).then((res) => {
        ...
        <div class="col-12 lg:col-12 xl:col-12">
            <div class="card">
                ...
                <div class="flex flex-column sm:flex-row gap-2 align-items-center">
                    <Dropdown @keyup.enter="searchPatient" class="mt-1 mx-1 w-full" filter :options="hciList" optionLabel="description" optionValue="healthcareInstitutionID" placeholder="Select Referring HCI" v-model="hciID" />
