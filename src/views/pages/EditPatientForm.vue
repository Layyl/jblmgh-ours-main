...
const collateFileNames = () => {
    ...
    } else if (patientData.value.patientFiles.length > 0 && filenameRef.value.files.length > 0) {
        patientData.value.patientFiles += ', ';
    }
...
const validateRequiredFields = () => {
    ...
    // Validate patientContact format
    const contactField = document.querySelector('input[name="patientContact"]');
    const contactPattern = /^\(\d{3}\) \d{3}-\d{4}$/;
    if (contactField && !contactPattern.test(contactField.value)) {
        error = true;
        if (!firstErrorField) {
            firstErrorField = contactField;
        }
        contactField.classList.add('p-invalid');
    } else if (contactField) {
        contactField.classList.remove('p-invalid');
    }
...
const saveData = async (toPost) => {
    sendReferral.value = false;
    savedReferralID.value = patientData.value.referralID;
    console.log(savedReferralID.value);
            ...
            <div class="card mb-0">
                ...
                <div class="p-fluid formgrid grid">
                    ...
                    <div class="field col-12 md:col-6">
                        ...
                        <Skeleton v-if="fetching" width="100%" height="2rem" class="mb-2"></Skeleton>
                        <Dropdown v-else v-model="patientData.isRabies" :options="rabies" optionLabel="rabies" optionValue="value" placeholder="Indicate if patient is rabies patient" />
                    </div>
            ...
            <div class="card mb-0">
                ...
                <div class="p-fluid formgrid grid">
                    ...
                    <div class="field col-12 md:col-6">
                        ...
                        <Skeleton v-if="fetching" width="100%" height="2rem" class="mb-2"></Skeleton>
                        <InputMask v-else:required="patientData.isSignore == 0 || !patientData.isSignore" v-model="patientData.patientContact" id="phone" mask="(999) 999-9999" placeholder="(999) 999-9999" name="patientContact" />
                    </div>
                    <div class="field col-12 md:col-6">
                        <Skeleton v-if="fetching" width="100%" height="2rem" class="mb-2"></Skeleton>
        ...
        <div class="col-12 lg:col-12 xl:col-12">
            <div class="card mb-0">
                ...
                <div class="p-fluid formgrid grid">
                    <div class="field col-12 md:col-6">
                        <Skeleton v-if="fetching" width="100%" height="2rem" class="mb-2"></Skeleton>
                        <label v-else for="Height">Height (ft/inches) <span class="text-red-600">*</span></label>
                    ...
                    <div class="field col-12 md:col-6">
                        ...
                        <Skeleton v-if="fetching" width="100%" height="2rem" class="mb-2"></Skeleton>
                        <InputText v-else :useGrouping="false" required v-model="patientData.temperature" id="temp" type="text" />
                    </div>
                    <div class="field col-12 md:col-6">
                        <Skeleton v-if="fetching" width="100%" height="2rem" class="mb-2"></Skeleton>
                    ...
                    <div class="field col-12 md:col-6">
                        <Skeleton v-if="fetching" width="100%" height="2rem" class="mb-2"></Skeleton>
                        <label v-else for="pain">CBG</label>
                        <Skeleton v-if="fetching" width="100%" height="2rem" class="mb-2"></Skeleton>
                        <InputNumber v-else :useGrouping="false" v-model="patientData.cbg" id="pain" type="text" />
                    </div>
                    <div class="field col-12 md:col-6">
                        <Skeleton v-if="fetching" width="100%" height="2rem" class="mb-2"></Skeleton>
                    ...
                    <div v-else class="field col-12 md:col-6">
                        ...
                        <Dropdown required :options="critical" v-model="patientData.isCritical" optionLabel="injury" optionValue="value" placeholder="Is the Referral Urgent?" />
                    </div>
                </div>
            </div>
        </div>
