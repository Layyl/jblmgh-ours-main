        ...
        <div class="wrapper3">
            <div class="about-box" data-aos="fade-up" data-aos-duration="700">
                ...
                <div class="about-box-title" data-aos="fade-up" data-aos-duration="700">
                    ...
                    <p>
                        The One Unified Referral System (OURS) is a platform designed to facilitate seamless patient referrals between Jose B. Lingad Memorial General Hospital and collaborating medical institutions. OURS serves as a digital bridge,
                        connecting healthcare providers and streamlining the referral process with efficiency and precision
                    </p>
    ...
    <section class="work-process-sec w-100 float-left padding-bottom padding-top" id="process">
        <div class="container">
            <div class="generic-title text-center" data-aos="fade-up" data-aos-duration="700">
                ...
                <h2 class="mb-0">Let’s See How Referrals Work</h2>
            </div>
        ...
        <div class="container">
            <div class="footer-inner-con d-flex flex-column flex-md-row justify-content-center align-items-center">
                <div class="footer-box footer-logo-box col-12 col-md-6 mb-4 mb-md-0">
                    ...
                    <p>
                        Welcome to the One Unified Referral System (OURS) - your comprehensive solution for interhospital patient referrals. Developed to streamline, monitor, and expedite the referral process between Jose B. Lingad Memorial General
                        Hospital and other medical institutions, OURS sets a new standard for efficiency and communication in healthcare.
                    </p>
                </div>
